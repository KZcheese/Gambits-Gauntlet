...
namespace ActiveRagdoll{
    public class MultiplayerActiveRagdollController : MonoBehaviour
{
    public MultiplayerPhysicsJointController[] limbs;
    ...
    public MultiplayerPlayerController player;
    ...
    public void ResetAllLimbStrength(){
        foreach(MultiplayerPhysicsJointController limb in limbs){
